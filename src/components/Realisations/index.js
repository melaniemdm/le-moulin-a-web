...
export default function Realisations(){
 ...
 <a href={dsn} target="_blank" rel='noreferrer'> <img src={img6} alt="Image2" width="100%" /></a>
    <a href='https://intelligence-canine.fr/' target="_blank" rel='noreferrer'>  <img src={img3} alt="Image3" width="100%" /></a> 
      ...
      <a href={simpliste} target="_blank" rel='noreferrer'><img src={img10} alt="Image6" width="100%" /></a> 
      <a href={acoss} target="_blank" rel='noreferrer'><img src={img4} alt="Image7" width="100%" /></a> 
     
      </div>
      <div className="column">
      <a href='https://adaptativeresume.netlify.app' target="_blank" rel='noreferrer'> <img src={img9} alt="Image8" width="100%" /></a>
      <a href={nature} target="_blank" rel='noreferrer'> <img src={img5} alt="Image9" width="100%" /></a>
